...
public class AccountService {
    ...
    public Optional<Account> CheckAndDisplay(Long id, String name)
    {
    ...
    public Account create(Account account)
    {
        ...
        userService.createUser(newAccount.getName(),"{noop}"+newAccount.getName(),"USER","ACTIVE",newAccount.getAccount_id());
